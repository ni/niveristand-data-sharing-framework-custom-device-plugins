	...
	<Item Name="PharLap ETS PXI" Type="RT PXI Chassis">
		...
		<Item Name="Build Specifications" Type="Build">
			<Item Name="UDP" Type="Packed Library">
				...
				<Property Name="Destination[0].path" Type="Path">/x86/Components/UDP.lvlibp</Property>
				...
				<Property Name="Source[0].itemID" Type="Str">{4AFD3D10-3102-4B05-A9C0-358BDDC7BA44}</Property>

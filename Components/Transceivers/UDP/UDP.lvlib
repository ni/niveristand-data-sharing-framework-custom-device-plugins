...
<Library LVVersion="17008000">
	...
	<Item Name="User Interfaces" Type="Folder">
		<Item Name="UDP Thread User Interface.lvclass" Type="LVClass" URL="../UI/Thread/UDP Thread User Interface.lvclass"/>
		<Item Name="UDP Transfer Rx User Interface.lvclass" Type="LVClass" URL="../UI/Transfer Rx/UDP Transfer Rx User Interface.lvclass"/>
		<Item Name="UDP Transfer Tx User Interface.lvclass" Type="LVClass" URL="../UI/Transfer Tx/UDP Transfer Tx User Interface.lvclass"/>
	</Item>
	<Item Name="UDP Configurations.lvclass" Type="LVClass" URL="../Configuration/UDP Configurations.lvclass"/>
	<Item Name="UDP Transceiver.lvclass" Type="LVClass" URL="../Transceiver/UDP Transceiver.lvclass"/>
	<Item Name="UDP User Interfaces.lvclass" Type="LVClass" URL="../UI/UDP User Interfaces.lvclass"/>
</Library>

				...
				<Item Name="Public" Type="Folder">
					<Item Name="Classes" Type="Folder">
						...
						<Item Name="Status" Type="Folder">
							...
							<Item Name="Transfer Group Status.lvclass" Type="LVClass" URL="../Engine/DSF Core.lvlibp/Engine/Classes/Transfer Group Status/Transfer Group Status.lvclass"/>
						</Item>
					...
					<Item Name="Typedefs" Type="Folder">
						...
						<Item Name="DSF Transfer Group Status.ctl" Type="VI" URL="../Engine/DSF Core.lvlibp/DSF Configuration API/Public/Controls/DSF Transfer Group Status.ctl"/>
					...
					<Item Name="VIs" Type="Folder">
						<Item Name="Configuration" Type="Folder">
							...
							<Item Name="Poly VIs" Type="Folder">
								...
								<Item Name="Transfer Count (Framework).vi" Type="VI" URL="../Engine/DSF Core.lvlibp/DSF Configuration API/Public/Transfer Count (Framework).vi"/>
								<Item Name="Transfer Count (Plugin).vi" Type="VI" URL="../Engine/DSF Core.lvlibp/DSF Configuration API/Public/Transfer Count (Plugin).vi"/>
								<Item Name="Transfer Count (Transfer Group).vi" Type="VI" URL="../Engine/DSF Core.lvlibp/DSF Configuration API/Public/Transfer Count (Transfer Group).vi"/>
								<Item Name="Transfer Group Count (Framework).vi" Type="VI" URL="../Engine/DSF Core.lvlibp/DSF Configuration API/Public/Transfer Group Count (Framework).vi"/>
								<Item Name="Transfer Group Count (Plugin).vi" Type="VI" URL="../Engine/DSF Core.lvlibp/DSF Configuration API/Public/Transfer Group Count (Plugin).vi"/>
							...
							<Item Name="Transfer Count.vi" Type="VI" URL="../Engine/DSF Core.lvlibp/DSF Configuration API/Public/Transfer Count.vi"/>
							<Item Name="Transfer Group Count.vi" Type="VI" URL="../Engine/DSF Core.lvlibp/DSF Configuration API/Public/Transfer Group Count.vi"/>
						</Item>
